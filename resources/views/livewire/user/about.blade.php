            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="{{ asset('Mentor/assets/img/about.jpg') }}" class="img-fluid pb-5" alt="">
                        <img src="{{ asset('Mentor/assets/img/about.jpg') }}" class="img-fluid pt-5" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-check-circle"></i> L’Ecole de Gestion d’Informatique et de Commerce
                                (EGIC)
                                est une Business School dont la mission consiste à former des femmes et des hommes
                                capables
                                ...
                                Depuis sa création en 1993, l’EGIC n’a cessé de faire évoluer son offre de formation,
                                aussi
                            ...
                            <li><i class="bi bi-check-circle"></i> En effet, les formations de qualité (BTS, formations
                                ...
                                professionnelles, dont elle a fait ses fondamentaux, l’école forme-t-elle des cadres de
                                haut
                                niveau, aptes à intervenir efficacement dans la gestion des entreprises et des services
                                de
                                l’Etat.</li>
